            ...
            <div class="max-w-xl mx-auto">
                ...
                <form class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="Nama penyanyi"
                            class="w-full px-4 py-2 border-2 border-[#3D236B] rounded-lg text-[#5B518D] font-spicy placeholder-[#5B518D] text-[16px]" />
                    </div>

                    <!-- Unggah Lagu -->
                    <div>
                        <input ref="laguInput" type="file" accept=".mp3,audio/*" class="hidden"
                            @change="handleLaguUpload" />
                    ...
                    <!-- Unggah Gambar Album -->
                    <div>
                        <input ref="gambarInput" type="file" accept="image/*" class="hidden"
